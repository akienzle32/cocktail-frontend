        ...
        <div className="flex flex-col items-center justify-center bg-darkred mt-8 w-1/3 pb-10 rounded">
            <div className="mt-6 mb-6 text-center">
                <form className="flex flex-col items-start justify-center text-lg mt-4 text-black">
                    ...
                    <input className="m-2 w-60 pl-1 rounded outline-cadetblue" type="text" id="username"></input>
                    <label className="text-white"htmlFor="password">Password:</label>
                    <input className="m-2 w-60 pl-1 text-black rounded outline-cadetblue" type="password"></input>
                </form>
            </div>
            <button className="w-32 text-lg text-white bg-cadetblue pl-4 pr-4 pt-1 pb-1.5 rounded-md hover:bg-lightcadetblue">Login</button>
            <br></br>
